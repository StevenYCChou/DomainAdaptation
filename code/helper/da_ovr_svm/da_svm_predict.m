function [acc, predict] = da_svm_predict( ...
...
[bestc, bestg, bestcv] = get_da_svm_cv_best_parameter(X_source_train, y_source_train, X_target_train, y_target_train, c_list, g_list, n_fold);
